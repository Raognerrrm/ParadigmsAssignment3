...
case $opt in
	...
	4) echo printRedundantFile \"../$fileIn\" | ghci Deadcode.hs -v0 > ../$fileOut ;;#do redundant
	...
	echo printRedundantFile \"../temp.intermediate\" | ghci Deadcode.hs -v0 > ../$fileOut
	rm ../temp.intermediate ;;
	...
	echo printRedundantFile \"../temp.intermediate\" | ghci Deadcode.hs -v0 > ../temp.intermediate2
